...
В синтаксисе с отступами выражения могут занимать несколько строк, если разрывы строк происходят в местах, где выражение не может закончиться. Это включает внутри круглых скобок или других типов скобок, или между ключевыми словами в специфичном для Sass @-правиле.
