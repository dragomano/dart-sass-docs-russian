...
Сначала установите Sass, используя один из вариантов ниже, затем выполните `sass --version`, чтобы убедиться в правильности установки. Если всё прошло успешно, вы увидите номер текущей версии. Вы также можете выполнить `sass --help` для получения дополнительной информации об интерфейсе командной строки.
