...
Автономный исполняемый файл командной строки Dart Sass использует молниеносно быструю виртуальную машину Dart для компиляции ваших таблиц стилей. Чтобы установить Dart Sass в командной строке, ознакомьтесь с [инструкциями по установке](install). После запуска вы можете использовать его для компиляции файлов:
