...
### Приём произвольных аргументов {#taking-arbitrary-arguments}
...
#### Приём произвольных именованных аргументов {#taking-arbitrary-keyword-arguments}

Списки аргументов также могут использоваться для приёма произвольных именованных аргументов. Функция [`meta.keywords()`](../modules/meta#keywords) принимает список аргументов и возвращает все дополнительные именованные аргументы, которые были переданы функции, в виде [карты](../values/maps) от имён аргументов (без `$`) к их значениям.
