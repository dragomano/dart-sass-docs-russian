...
* Если вы используете JavaScript API, просто добавьте [`new NodePackageImporter()`](../js-api/classes/NodePackageImporter/) в опцию `importers`.
